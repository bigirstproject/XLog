...
public class Log {
    ...
    private static ILog debugLog = new ILog() {
    ...
    private static ILog ILog = debugLog;


    public static void setILog(ILog imp) {
        ILog = imp;
    }
    ...
    public static void f(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logF(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void e(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logE(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void w(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logW(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void i(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logI(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void d(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logD(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
    ...
    public static void v(String tag, final String format, final Object... obj) {
        if (ILog != null) {
            ...
            ILog.logV(tag, "", "", 0, Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), log);
        }
    }
